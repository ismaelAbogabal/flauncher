...
class FLauncherChannel {
  static const _methodChannel = MethodChannel('com.mawaqit.launcher/method');
  static const _eventChannel = EventChannel('com.mawaqit.launcher/event');
  ...
  Future<int> upTime() async => await _methodChannel.invokeMethod("upTime");
